...
public class EquipoResourceTest {
    ...
    public void createEquipo() throws Exception {
        ...
        assertThat(testEquipo.getFechaCreacion().toDateTime(DateTimeZone.UTC)).isEqualTo(DEFAULT_FECHA_CREACION);
    }
    ...
    public void updateEquipo() throws Exception {
        ...
        assertThat(testEquipo.getFechaCreacion().toDateTime(DateTimeZone.UTC)).isEqualTo(UPDATED_FECHA_CREACION);
    }
