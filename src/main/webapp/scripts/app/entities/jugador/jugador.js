    ...
    .config(function ($stateProvider) {
        $stateProvider
            .state('jugador', {
                ...
                data: {
                    roles: ['ROLE_USER'],
                    pageTitle: 'ligaApp.jugador.home.title'
                },
                views: {
                    'content@': {
            ...
            .state('jugador.detail', {
                ...
                data: {
                    roles: ['ROLE_USER'],
                    pageTitle: 'ligaApp.jugador.detail.title'
                },
                views: {
                    'content@': {
            ...
            .state('jugador.new', {
                ...
                onEnter: ['$stateParams', '$state', '$modal', function($stateParams, $state, $modal) {
                    $modal.open({
                        ...
                        resolve: {
                            entity: function () {
                                return {nombre: null, nacimiento: null, canastas: null, asistencias: null, rebotes: null, posicion: null, id: null};
                            }
                        }
