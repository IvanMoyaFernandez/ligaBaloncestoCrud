...
import com.liga.repository.EquipoRepository;
import com.liga.web.rest.util.HeaderUtil;
import com.liga.web.rest.util.PaginationUtil;
...
public class EquipoResource {
    ...
    @Timed
    public ResponseEntity<Equipo> create(@Valid @RequestBody Equipo equipo) throws URISyntaxException {
    ...
    @RequestMapping(value = "/equipos",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Equipo> update(@Valid @RequestBody Equipo equipo) throws URISyntaxException {
